...
const DATA = {
  sellers: [
    {id:1,av:'av-a',em:'🔥',name:'sneaker.kang',handle:'@sneaker.kang',loc:'서울',
    ...
    {id:2,av:'av-b',em:'💎',name:'luxe.j',handle:'@luxe.j',loc:'강남',
    ...
    {id:3,av:'av-c',em:'⌚',name:'watch.yk',handle:'@watch.yk',loc:'부산',
    ...
    {id:4,av:'av-d',em:'🧥',name:'techwear.s',handle:'@techwear.s',loc:'홍대',
    ...
    {id:5,av:'av-e',em:'👟',name:'kicks.p',handle:'@kicks.p',loc:'인천',
    ...
    {id:6,av:'av-a',em:'💍',name:'gold.s',handle:'@gold.s',loc:'서울',
